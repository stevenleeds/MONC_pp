...
'TRAC2':['tracer squared',u'-'],
'PURITY':['purity tracer concentration',u'-'],
'PURITY2':['purity squared',u'-'],
'RADIO1':['radioactive tracer concentration',u'-'],
'RADIO1':['radioactive tracer 1 concentration',u'-'],
...
'CLDBASE':['cloud base',u'm','min'],
'THV_MAXCLD':['virtual potential temperature perturbation',u'-'],
}
