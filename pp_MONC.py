...
class dataprocessor(dataorganizer):
    ...
    def processor(self):
        ...
        self.dom_var('TRACER_CW',mean(interpolate_ze(rqtracer)*w))
        self.dom_var('TRACER_CCW',mean(interpolate_ze(rqtracer*rqtracer)*w))
        ...
        self.ref_var('TRACERPROF_CW',mean_2d(interpolate_ze(rqtracer)*w))
        self.ref_var('TRACERPROF_CCW',mean_2d(interpolate_ze(rqtracer*rqtracer)*w))
