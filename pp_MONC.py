...
class dataprocessor(dataorganizer):
    ...
    def processor(self):
        ...
        self.dom_var('TRACER_CDPDZ',mean(rq3*dpdz))
        self.dom_var('TRACER_CCDPDZ',mean(rq3*rq3*dpdz))
        self.dom_var('TRACER_CDBUOYPDZ',mean(rq3*dbuoypdz))
        self.dom_var('TRACER_CCDBUOYPDZ',mean(rq3*rq3*dbuoypdz))
        self.ref_var('TRACERPROF_CDPDZ',mean_2d(rq3*dpdz))
        self.ref_var('TRACERPROF_CCDPDZ',mean_2d(rq3*rq3*dpdz))
        self.ref_var('TRACERPROF_CDBUOYPDZ',mean_2d(rq3*dbuoypdz))
        self.ref_var('TRACERPROF_CCDBUOYPDZ',mean_2d(rq3*rq3*dbuoypdz))
        del dp
        ...
        self.dom_var('TRACER_CTVORT',mean(rq3*tvort))
        self.dom_var('TRACER_CCTVORT',mean(rq3*rq3*tvort))
        self.ref_var('TRACERPROF_CTVORT',mean_2d(rq3*tvort))
        self.ref_var('TRACERPROF_CCTVORT',mean_2d(rq3*rq3*tvort))
        ...
        self.dom_var('TRACER_CQCRITERION',mean(rq3*qq))
        self.dom_var('TRACER_CCQCRITERION',mean(rq3*rq3*qq))
        self.ref_var('TRACERPROF_CQCRITERION',mean_2d(rq3*qq))
        self.ref_var('TRACERPROF_CCQCRITERION',mean_2d(rq3*rq3*qq))
        del oo,ss,qq
